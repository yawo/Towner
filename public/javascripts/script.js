...
var productDetailsTemplate = '<div class="product-details ui-corner-all "><span id="product-details-_id" class="ui-helper-hidden"></span><table cellpadding="2px"><tr class="details-head ui-corner-all"><td width="75%"><b id="product-details-title">Title</b></td><td id="product-details-actions"><span id="like-action" title="Did you like it ?" onclick="productScore(1,0,0)"></span><span id="unlike-action" title="Something hurts about it ?" onclick="productScore(-1,0,0)"></span><span id="signal-action" title="Is this erronous or Bad ?" onclick="productScore(-2,0,0)"/>&nbsp;*&nbsp;<span id="mark-action" title="How much will you mark it on 20 points?" onclick="productScore(2,0,0)"/><input name="details-mark" id="details-mark" placeholder="0" size="1" class="input details-mark ui-widget ui-corner-all" />&nbsp;&nbsp;*&nbsp;&nbsp;<span id="close-action" title="close" onclick="productDetailsClear()"></span></td></tr><tr><td colspan="2" class="details-description"><div id="product-details-description"></div></td></tr></table></div>';
var zoom=5;
